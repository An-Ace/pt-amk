<template>
	<div class="wrapper flex grow" :class="[{ 'sidebar-open': sidebarOpen }, `sidebar-position-${sidebarPosition}`]">
		<div class="sidebar flex flex-col border-r" ref="sidebar">
			<div class="sidebar-header flex items-center justify-between">
				<slot name="sidebar-header" :handleClose="() => sidebarOpen = false"></slot>
			</div>
			
			<div class="sidebar-main grow">
				<n-scrollbar style="max-height: 100%">
					<div class="sidebar-main-content">
						<slot name="sidebar-content" :handleClose="() => sidebarOpen = false"></slot>
					</div>
				</n-scrollbar>
			</div>
		...
		<div class="main flex-grow flex flex-col">
			<div class="main-toolbar flex items-center">
				...
				<div class="flex items-center justify-between w-full">
					<slot name="main-toolbar" :toggleMenubar="() => menubarOpen = !menubarOpen"></slot>
				</div>
			</div>
			...
			<div class="main-footer grid items-center border-none border-0 my-2">
		...
		<div class="menubar sidebar flex flex-col border-l w-full" ref="sidebar" v-show="menubarOpen">
			...
			<div class="sidebar-main grow">
				<n-scrollbar style="max-height: 100%">
					<div class="sidebar-main-content">
						<slot name="menubar-content"></slot>
					</div>
				</n-scrollbar>
			</div>
			<!-- <div class="sidebar-footer flex items-center">
